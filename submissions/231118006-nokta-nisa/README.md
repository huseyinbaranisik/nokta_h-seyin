...
### 2026-05-12 16:30 — Modernizasyon & Uzman Desteği
- **Uzman Desteği (Human Support):** Nokta Vision AI asistanına kritik mühendislik ve tıbbi konularda uzman desteği (Hernes Engineering & Uzman Doktorlar) önerme yeteneği kazandırıldı.
- **Modern UI/UX Revizyonu:** Uygulama genelinde koyu tema (dark theme) ve glassmorphism estetiğine geçildi. Daha akıcı animasyonlar (LayoutAnimation) ve profesyonel navigasyon yapısı eklendi.
- **Vision Modu:** Gemini Vision API desteği ile kameradan alınan görüntülerin AI tarafından analiz edilmesi altyapısı kuruldu.
- **AI Motoru:** Gemini API (1.5 Flash) ile multimodal (Ses, Görüntü, Metin) yetenekler aktif hale getirildi.
